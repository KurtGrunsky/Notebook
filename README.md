...
### Reflections On This Module Overall
  ...
  However (and this is not something I admit proudly), I realized that I had missed one of the readings. Specifically, I could not find a way to get access to the first reading for March 28th (the academic article). I meant to bring this to the attention of the class on the day it was assigned for, but instead got caught up in the discussion and forgot about it until now. This is mostly just my explanation behind why I have hypothes.is notes for the other articles, but not that one. I am unsure as to how many other people in the class had this same problem, but I know that at least one other did.
